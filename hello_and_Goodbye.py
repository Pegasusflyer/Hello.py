...
if myPassword == 'cake':
    print('Welcome, back Hailey! How was your day?') # Asks about day
myDay = input()
if myDay == 'good':
...
print('It was nice to see you again Hailey!Goodbye.') # Says Goodbye
myGoodbye = input()
if myGoodbye == 'Bye':
...
if stay == 'Goodbye':
    print('Bye!')
if stay == 'stay':
    print('I have to go Hailey...goodbye.')
